  ...
  _createClass(TwitterLogin, [{
    ...
    value: function getRequestToken() {
      ...
      return this.props.client.query({
        ...
        var authenticationUrl = "https://api.twitter.com/oauth/authenticate?oauth_token=" + result.data.twitterRequestToken + "&force_login=" + _this2.props.forceLogin;
...
TwitterLogin.propTypes = {
  ...
  requestTokenQuery: _propTypes2.default.any.isRequired,
